...
직무 전환을 위해 다양한 데이터를 다루며 포트폴리오를 만들어보는 과정에서, 부트캠프와 공모전의 데이터 과제와 공공 데이터 포털의 데이터를 가지고 여러 분석 과제를 진행해 보았습니다.
또한, 데이콘과 캐글에서 다양한 데이터를 활용하여 데이터 분석, 모델링, 그리고 머신러닝을 진행했습니다.
